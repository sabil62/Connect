...
let App = class App {
  ...
  buildHands(thehand) {
    ...
    const handModelFactory = new XRHandModelFactory().setPath("../hand-models");
  ...
  checkTouch(indexTip, hand) {
    const distanceIndex1 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.plane1.getWorldPosition(tmpVector2));
    if (distanceIndex1 < 0.05) {
      console.log("Touch White");
      this.drawColor = 0xffffff;
    }

    const distanceIndex2 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.plane2.getWorldPosition(tmpVector2));
    if (distanceIndex2 < 0.05) {
      console.log("Touch Yellow");
      this.drawColor = 0xffff00;
    }

    const distanceIndex3 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.plane3.getWorldPosition(tmpVector2));
    if (distanceIndex3 < 0.05) {
      console.log("Touch Red");
      this.drawColor = 0xff0000;
    }

    const distanceIndex4 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.plane4.getWorldPosition(tmpVector2));
    if (distanceIndex4 < 0.05) {
      console.log("Touch Blue");
      this.drawColor = 0x0000ff;
    }

    const distanceIndex5 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.plane5.getWorldPosition(tmpVector2));
