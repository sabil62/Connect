...
let App = class App {
  ...
  checkTouch(indexTip, hand) {
    const distanceIndex1 = indexTip
      ...
      .distanceTo(this.textMesh1.getWorldPosition(tmpVector2));
    ...
    const distanceIndex2 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.textMesh2.getWorldPosition(tmpVector2));
    ...
    const distanceIndex3 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.textMesh3.getWorldPosition(tmpVector2));
    ...
    const distanceIndex4 = indexTip
      .getWorldPosition(tmpVector1)
      .distanceTo(this.textMesh4.getWorldPosition(tmpVector2));
